...
export const metadata: Metadata = {
  title: 'Certifications & Honors — Akash Maurya',
  description: 'Verified certifications from Google, DeepLearning.AI, Infosys, and national merit awards including the INSPIRE Scholarship.',
};
        ...
        <div className="border-b border-stone-200 dark:border-stone-800 bg-stone-100/60 dark:bg-stone-900/60 py-4 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2 text-xs font-mono text-stone-500 dark:text-stone-400">
              ...
              <span>/</span>
              <span className="text-stone-900 dark:text-stone-100 font-semibold">Awards & Certifications</span>
            </div>
            <Link
              href="/contact"
