...
export const metadata: Metadata = {
  title: 'Research Interests — Akash Maurya',
  description: 'Image Super-Resolution, Self-Supervised Learning (SimCLR), Biometric Identification, Computer Vision, and Robotics.',
};
        ...
        <div className="border-b border-stone-200 dark:border-stone-800 bg-stone-100/60 dark:bg-stone-900/60 py-4 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2 text-xs font-mono text-stone-500 dark:text-stone-400">
              ...
              <span>/</span>
              <span className="text-stone-900 dark:text-stone-100 font-semibold">Research Interests</span>
            </div>
            <Link
              href="/contact"
